      ...
      <div className='mx-auto w-10/12 bg-white rounded-xl p-8 grid grid-cols-2 gap-6'>
        <div className='space-y-6'>
          ...
          <div className='relative h-[500px] bg-slate-900 rounded-lg p-4'>
            ...
            />
            <input onChange={showImage} accept="image/*" type='file' className='absolute top-0 left-0 w-full h-full opacity-0 rounded-lg' />
          </div>
          <div>
            <form className='flex gap-4' onSubmit={resizeImage}>
              ...
              <button disabled={originalImage === "/sample.png"} className='bg-indigo-600 text-white font-medium py-2 px-8 rounded hover:bg-green-500 duration-300 hover:scale-105 transition-transform'>Resize</button>
            </form>
          </div>
        </div>
        <div className='space-y-6'>
